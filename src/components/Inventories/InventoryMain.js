  ...
  const debounceDropDown = useRef(
    debounce(
      (keyword, oh, exp, from, to) =>
        callApiKeywordSearch(keyword, from, to, oh, exp),
      300,
    ),
  ).current;
              ...
              <div className="col-lg-7 me-auto d-flex">
                ...
                <div className="me-1" style={{ flexGrow: "1" }}>
                  ...
                  >
                    ...
                    <option id="#ffc107" className="text-warning" value="HSD1">
                      Cảnh báo
                    </option>
                    <option id="#dc3545" className="text-danger" value="HSD0">
                      Hết hạn
                    </option>
                  </select>
                </div>
                <div className="me-1" style={{ flexGrow: "1" }}>
                  <select
                    defaultValue=""
                    name="oh"
                    className="form-control p-2 form-select"
                    id="OH-select"
                    style={{ fontWeight: "500" }}
                    onChange={handleChange}
                  >
                    ...
                    <option id="#ffc107" className="text-warning" value="OH1">
                      Số lượng sắp hết
                    </option>
                    <option id="#dc3545" className="text-danger" value="OH0">
                      Số lượng hết
                    </option>
                  </select>
                </div>
