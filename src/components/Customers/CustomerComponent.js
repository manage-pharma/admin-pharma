...
const CustomerComponent = (props) => {
      ...
      >
        ...
        <Modal.Body>
          <p>
            ...
            <span className="text-danger">{dataModal?.name}</span> ?
          </p>
        </Modal.Body>
        <Modal.Footer>
          <Button
  ...
  const debounceDropDown = useRef(
    debounce(
      (keyword, pageNumber) => callApiKeywordSearch(keyword, pageNumber),
      300,
    ),
  ).current;
                            ...
                            <div className="card-text text-muted">
                              {
                                ...
                                usageTime(customer.createdAt) > 12 &&
                                customer?.totalOrder /
                                  usageTime(customer.createdAt) >
                                  5 ? (
                                  <p
                                    className="m-0 badge bg-danger"
                                    style={{ fontSize: "16px" }}
                                  >
                                ...
                                customer?.totalOrder <= 10 &&
                                  ...
                                  <p
                                    className="m-0 badge bg-success  text-wrap"
                                    style={{
                                      minWidth: "4rem",
                                      fontSize: "16px",
                                    }}
                                  ...
                                  <p
                                    className="m-0 badge bg-secondary text-wrap"
                                    style={{
                                      minWidth: "4rem",
                                      fontSize: "16px",
                                    }}
...
export default withAuthorization(CustomerComponent, [
  PERMISSIONS.isSaleAgent.access_customer,
]);
