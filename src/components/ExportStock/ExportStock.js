  ...
  const MyVerticallyCenteredModal = (props) => {
    return (
      ...
      >
        ...
        <Modal.Body>
          <p>
            Bạn chắc chắn muốn cập nhật trang thái:{" "}
            <span className="text-warning">{dataModal?.exportCode}</span> ?
          </p>
        </Modal.Body>
        <Modal.Footer>
          <Button
  ...
  const MyVerticallyCenteredModalCancel = (props) => {
    return (
      ...
      >
        ...
        <Modal.Body>
          <p>
            Bạn có chắc chắn hủy đơn{" "}
            <span className="text-danger">{dataModalCancel?.exportCode}</span> ?
          </p>
        </Modal.Body>
        <Modal.Footer>
          <Button
