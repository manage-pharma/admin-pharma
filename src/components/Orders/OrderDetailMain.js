...
const OrderDetailMain = (props) => {
  ...
  const { loading: loadingCompleted, success: successCompleted } =
    orderCompleted;
      ...
      >
        ...
        <Modal.Body>
          <p>
            ...
            <span className="text-danger">{" " + orderItems?._id}</span> ?
          </p>
        </Modal.Body>
        <Modal.Footer>
          <Button
                    ...
                    <>
                      {orderItems.isComformed ? (
                        ...
                        <>
                          ...
                          <button
                            onClick={conformHanlder}
                            className="btn btn-dark col-12 user-select-none mt-2"
                          >
                            XÁC NHẬN ĐƠN HÀNG
                          </button>
                        </>
                      ...
                      (orderItems.isDelivered &&
                        ...
                        orderItems.paymentMethod == "Paypal" ? (
                        <>
