...
const DashboardChart = () => {
  ...
  const handleChangeFilter = filterTongQuan => {
    const { selectedProduct, createdAtFrom, createdAtTo, typeTime, isToday } = filterTongQuan
      ...
      <section className="content-main chart-event" ref={chartContainerDomRef}>
        ...
        <div className="card card-custom mb-4 shadow-sm">
          <header className="card-header bg-aliceblue ">
              <FilterReport handleChangeFilter={handleChangeFilter} refreshData={refreshData}/>
          </header>
