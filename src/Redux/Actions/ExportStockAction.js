...
//ADMIN EXPORT CREATE
export const createExportStock = ({ note, reason, isExportCanceled, user, exportItems, totalPrice, exportedAt }) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.post(`/api/export-stock/`,
        {
          note, reason, isExportCanceled, user, exportItems, totalPrice, exportedAt
        }
...
export const statusExportStock = (id) => async (dispatch, getState) => {
  ...
  //ADMIN UPDATE EXPORT
  export const updateExportStock = ({ note, reason, isExportCanceled, user, exportItems, totalPrice, exportedAt, exportId }) => async (dispatch, getState) => {
    try {
