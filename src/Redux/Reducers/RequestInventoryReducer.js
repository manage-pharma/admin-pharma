...
// REQ_INVENTORY LIST
export const reqInventoryListReducer = (
  state = { reqInventory: [] },
  action,
) => {
  switch (action.type) {
  ...
  switch (action.type) {
    ...
    case REQ_INVENTORY_DETAILS_SUCCESS:
      return {
        loading: false,
        success: true,
        reqInventoryItem: action.payload,
      };
  ...
  switch (action.type) {
    ...
    case REQ_INVENTORY_CREATE_SUCCESS:
      return {
        loading: false,
        success: true,
        reqInventoryCreated: action.payload,
      };
  ...
  switch (action.type) {
    ...
    case REQ_INVENTORY_STATUS_SUCCESS:
      return {
        loading: false,
        success: true,
        reqInventoryStatus: action.payload,
      };
  ...
  switch (action.type) {
    ...
    case REQ_INVENTORY_UPDATE_SUCCESS:
      return {
        loading: false,
        success: true,
        reqInventoryUpdated: action.payload,
      };
  ...
  switch (action.type) {
    ...
    case REQ_INVENTORY_CANCEL_SUCCESS:
      return {
        loading: false,
        success: true,
        reqInventoryCancel: action.payload,
      };
