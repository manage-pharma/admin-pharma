...
// EXPORT_STOCK LIST
export const exportStockListReducer = (
  state = { stockExported: [] },
  action,
) => {
  switch (action.type) {
  ...
  switch (action.type) {
    ...
    case EXPORT_STOCK_CREATE_SUCCESS:
      return {
        loading: false,
        success: true,
        exportStockCreated: action.payload,
      };
  ...
  switch (action.type) {
    ...
    case EXPORT_STOCK_STATUS_SUCCESS:
      return {
        loading: false,
        success: true,
        exportStockStatus: action.payload,
      };
  ...
  switch (action.type) {
    ...
    case EXPORT_STOCK_UPDATE_SUCCESS:
      return {
        loading: false,
        success: true,
        exportStockUpdated: action.payload,
      };
  ...
  switch (action.type) {
    ...
    case EXPORT_STOCK_CANCEL_SUCCESS:
      return {
        loading: false,
        success: true,
        exportStockCancel: action.payload,
      };
