import {
  ...
  DRUGSTORE_DELETE_REQUEST,
  DRUGSTORE_DELETE_SUCCESS,
  DRUGSTORE_DELETE_FAIL,
  DRUGSTORE_UPDATE_REQUEST,
  DRUGSTORE_UPDATE_SUCCESS,
  DRUGSTORE_UPDATE_FAIL,
  DRUGSTORE_UPDATE_RESET,
  DRUGSTORE_DELETE_RESET,
  ...
  DRUGSTORE_IMPORT_REQUEST,
  DRUGSTORE_IMPORT_SUCCESS,
  DRUGSTORE_IMPORT_FAIL,
  DRUGSTORE_IMPORT_RESET,
...
// CATEGORIES PRODUCT
export const drugstoreCategoriesReducer = (
  state = { drugstore: [] },
  action,
) => {
  switch (action.type) {
...
export const drugstoreCategoriesDrugReducer = (
  state = { drugstore: [] },
  action,
) => {
  switch (action.type) {
...
export const drugstoreUpdateReviewReducer = (
  state = { product: {} },
  action,
) => {
  switch (action.type) {
...
// IMPORT PRODUCT
export const drugstoreImportReducer = (
  state = { drugstoreImport: [] },
  action,
) => {
  switch (action.type) {
