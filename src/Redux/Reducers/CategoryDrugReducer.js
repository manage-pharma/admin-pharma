import {
  CATEGORY_DRUG_LIST_REQUEST,
  CATEGORY_DRUG_LIST_SUCCESS,
  CATEGORY_DRUG_LIST_FAIL,
  CATEGORY_DRUG_LIST_RESET,
  CATEGORY_DRUG_CREATE_REQUEST,
  CATEGORY_DRUG_CREATE_SUCCESS,
  CATEGORY_DRUG_CREATE_FAIL,
  CATEGORY_DRUG_CREATE_RESET,
  CATEGORY_DRUG_UPDATE_REQUEST,
  CATEGORY_DRUG_UPDATE_SUCCESS,
  CATEGORY_DRUG_UPDATE_FAIL,
  CATEGORY_DRUG_UPDATE_RESET,
  CATEGORY_DRUG_DELETE_REQUEST,
  CATEGORY_DRUG_DELETE_SUCCESS,
  CATEGORY_DRUG_DELETE_FAIL,
  CATEGORY_DRUG_DELETE_RESET,
} from "./../Constants/CategoryDrugConstants";
export const categoryDrugListReducer = (
  state = { categoriesDrug: [] },
  action,
) => {
  switch (action.type) {
...
export const categoryDrugUpdateReducer = (
  state = { categoryDrug: {} },
  action,
) => {
  switch (action.type) {
