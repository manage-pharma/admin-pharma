import { NOTIFICATION_LIST_REQUEST, NOTIFICATION_LIST_SUCCESS, NOTIFICATION_LIST_FAIL, NOTIFICATION_CREATE_FAIL, NOTIFICATION_CREATE_REQUEST, NOTIFICATION_CREATE_SUCCESS, NOTIFICATION_CREATE_RESET, NOTIFICATION_LIST_RESET, NOTIFICATION_UPDATE_REQUEST, NOTIFICATION_UPDATE_SUCCESS, NOTIFICATION_UPDATE_FAIL, NOTIFICATION_UPDATE_RESET, NOTIFICATION_DELETE_REQUEST, NOTIFICATION_DELETE_SUCCESS, NOTIFICATION_DELETE_FAIL, NOTIFICATION_DELETE_RESET, NOTIFICATION_SINGLE_SUCCESS, NOTIFICATION_SINGLE_RESET, NOTIFICATION_SET_OH, NOTIFICATION_SET_EXP } from '../Constants/NotificationConstants';
...
export const NotificationSetOHReducer = (state = {OH: []}, action) => {
  switch (action.type) {
    case NOTIFICATION_SET_OH:
      return {
        OH: action.payload
      };
    default:
...
export const NotificationSetEXPReducer = (state = {EXP: []}, action) => {
  switch (action.type) {
    case NOTIFICATION_SET_EXP:
      return {
        EXP: action.payload
      };
    default:
