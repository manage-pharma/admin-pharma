import { INVENTORY_TAG_FAIL, INVENTORY_TAG_REQUEST, INVENTORY_TAG_RESET, INVENTORY_TAG_SUCCESS, INVENTORY_LIST_FAIL, INVENTORY_LIST_REQUEST, INVENTORY_LIST_RESET, INVENTORY_LIST_SUCCESS } from './../Constants/InventoryConstants';
  // INVENTORY LIST
